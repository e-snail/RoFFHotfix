...
import roff.hotfix.annotation.MethodReplace;
import roff.hotfix.security.SecurityChecker;
...
public class AndFixManager {
	...
	private static final String AndFix_Package = "roff.andfix";
		...
		try {
			...
			ClassLoader patchClassLoader = new ClassLoader(classLoader) {
				...
				protected Class<?> findClass(String className)
					...
					if (clazz == null
							&& className.startsWith(AndFix_Package)) {
